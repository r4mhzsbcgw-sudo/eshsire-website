...
export const MEDIA_LIBRARY: MediaAsset[] = [
  ...
  {
    id: "homepage-hero-01-factory",
    category: "factory-production",
    src: "/images/home/carousel/homepage-hero-01-factory.webp",
    altEn: "ESHSIRE professional manufacturer and production base in Linyi, Shandong",
    altZh: "ESHSIRE 山东临沂生产基地与专业制造能力",
    usage: ["home-carousel"],
    isRealFactoryImage: true,
    notes: "Homepage carousel slide 1 — supplied WebP artwork",
  },
  {
    id: "homepage-hero-02-production-qc",
    category: "factory-production",
    src: "/images/home/carousel/homepage-hero-02-production-qc.webp",
    altEn: "ESHSIRE advanced production and strict quality control",
    altZh: "ESHSIRE 先进生产与严格品质管控",
    usage: ["home-carousel"],
    isRealFactoryImage: true,
    notes: "Homepage carousel slide 2 — supplied WebP artwork",
  },
  {
    id: "homepage-hero-03-products",
    category: "spc-details",
    src: "/images/home/carousel/homepage-hero-03-products.webp",
    altEn: "ESHSIRE SPC flooring, integrated wall panels and PVC ceiling product range",
    altZh: "ESHSIRE SPC地板、集成墙板和PVC天花板产品范围",
    usage: ["home-carousel"],
    isRealFactoryImage: true,
    notes: "Homepage carousel slide 3 — supplied WebP artwork",
  },
  {
    id: "homepage-hero-04-global-service",
    category: "warehouse-loading",
    src: "/images/home/carousel/homepage-hero-04-global-service.webp",
    altEn: "ESHSIRE flexible supply and global export service",
    altZh: "ESHSIRE 灵活供应与全球出口服务",
    usage: ["home-carousel"],
    isRealFactoryImage: true,
    notes: "Homepage carousel slide 4 — supplied WebP artwork",
  },
  {
    id: "about-hero",
    category: "factory-production",
