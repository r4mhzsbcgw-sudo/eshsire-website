...
export const zh: Dictionary = {
  ...
  home: {
    ...
    quoteSection: {
      ...
      title: "提交询价 · 可视化跟单服务",
      description:
        "告诉我们产品、数量和目标市场。跟单团队 24 小时内回复，并说明如何用图片和视频同步订单进度。",
    },
  },
  spcFlooring: {
  ...
  contact: {
    ...
    quoteForm: {
      ...
      submitting: "提交中...",
      successLabel: "已提交",
      successTitle: "感谢提交，我们已收到您的询价",
      successMessage:
        "跟单团队将在 24 小时内联系您，并说明我们如何同步样品、生产、包装和装柜等关键节点的图片与视频。",
      fallbackSuccessTitle: "感谢提交",
      fallbackSuccessMessage: "Your inquiry has been submitted. Our team will contact you soon.",
      validationErrorTitle: "请检查表单",
      validationErrorMessage: "部分字段缺失或格式不正确，请修改后重试。",
      deliveryFailedTitle: "提交暂时未能完成",
      deliveryFailedMessage: "提交暂时未能完成，请通过 WhatsApp 或邮箱直接联系我们。",
      contactWhatsApp: "WhatsApp 联系",
      contactEmail: "发送邮件",
      submitAnother: "再次提交询价",
      privacyNote: "您的信息仅用于回复询价和订单跟进，不会用于其他用途。",
    },
    form: {
      name: "您的姓名 *",
      company: "公司名称 *",
